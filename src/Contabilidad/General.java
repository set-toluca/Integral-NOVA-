        ...
        try
        {
           ...
           TComprobanteEx comprobante_ex=new TComprobanteEx();
                ...
                TTextoLibre cabecera= new TTextoLibre();
                    ...
                    cabecera.getTexto().add(" TIPO: "+t_modelo_vehiculo.getText().trim()+"        PLACA: "+t_placas_vehiculo.getText().trim()+"        KM: "+t_km.getText().trim()+"        AÑO:"+this.t_anio_vehiculo.getText().trim());
                    String texto="";
