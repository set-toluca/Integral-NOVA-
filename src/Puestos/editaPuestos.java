 ...
 * To changformatoTablae this template file, choose Tools | Templates
 ...
 */
public class editaPuestos extends javax.swing.JPanel {
    
    private Puestos actor;
    int[] puestos;
    DefaultTableModel model;
    String[] columnas = new String [] {"Clave","Nombre","Descripción"}; 
    ...
    public editaPuestos(Usuario usuario, String ses) {
        initComponents();
        sessionPrograma=ses;
        usr=usuario;
        formatoTabla();
    ...
    private void initComponents() {
        ...
        IdPuestos = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Edita de Puestos", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 12))); // NOI18N
        ...
        IdPuestos.setEditable(false);
        IdPuestos.setEnabled(false);
        IdPuestos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                IdPuestosActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(IdPuestos, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(IdPuestos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void IdPuestosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IdPuestosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_IdPuestosActionPerformed
    ...
    private void DescripcionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DescripcionKeyTyped
        evt.setKeyChar(Character.toUpperCase(evt.getKeyChar()));
        if(Descripcion.getText().length()>=150)
            evt.consume();
    ...
    private void b_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarActionPerformed
        ...
        if(usr.getEditaPuestos()==true)
        {
            ...
            {
                JOptionPane.showMessageDialog(null, "Selecciona el puesto que desees modificar");
                Nombre.requestFocus();
            }
        }
        else
    ...
    private void Selecciona2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Selecciona2ActionPerformed
        ...
        if(usr.getEditaPuestos()==true)
        {
            ...
            {
                this.borra_cajas();
                IdPuestos.setText(t_datos.getValueAt(t_datos.getSelectedRow(), 0).toString());
                Nombre.setText(t_datos.getValueAt(t_datos.getSelectedRow(), 1).toString());
                Descripcion.setText(t_datos.getValueAt(t_datos.getSelectedRow(), 2).toString());
                cajas(true, true, true, true);
            }
            else
            JOptionPane.showMessageDialog(null, "¡No hay un puesto seleccionado!");
        }
        else
            JOptionPane.showMessageDialog(null, "¡Acceso denegado!");
        if(session!=null)
            ...
            if(this.t_datos.getSelectedRow()>=0)
            {
                ...
                else
                {
                    if (JOptionPane.NO_OPTION== opt)
                          JOptionPane.showMessageDialog(null, "¡Selecciona el puesto correcto para eliminar!");  
                }  
            }
             else
             {
                 JOptionPane.showMessageDialog(null, "¡Selecciona el puesto que desees eliminar!");
                 Nombre.requestFocus();
             }
        }
        else
    ...
    private void Selecciona3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Selecciona3ActionPerformed
        ...
        if(usr.getEditaPuestos()==true)
        {
            altaPuestos obj= new altaPuestos(new javax.swing.JFrame(), true, usr, sessionPrograma);
    ...
    public javax.swing.JTextField IdPuestos;
    ...
    private void buscaDato()
    {
        ...
        if(resultList.size()>0)
        {
            ...
            for (Object o : resultList)
            {
                ...
                model.setValueAt(actor.getIdPuestos(), i, 0);
                model.setValueAt(actor.getNombre(), i, 1);
                if(actor.getDescripcion()!=null)
                    model.setValueAt(actor.getDescripcion(), i, 2);
                else
    ...
    private boolean modifica()
    {
        ...
        {
            session.beginTransaction();
            Object resp=session.createQuery("from Puestos obj where obj.nombre='"+Nombre.getText()+"' and obj.idPuestos!="+IdPuestos.getText()).uniqueResult();
            if(resp==null)
            {
                Puestos objeto = (Puestos)session.get(Puestos.class, Integer.parseInt(IdPuestos.getText()));
    ...
    private boolean elimina(String idPuestos)
    {
        Session session = HibernateUtil.getSessionFactory().openSession();
        try
        {
            session.beginTransaction();
            actor = (Puestos)session.get(Puestos.class, Integer.parseInt(idPuestos));
            
            if(actor.getEmpleados().isEmpty()==false)
            {
                session.getTransaction().rollback();
                JOptionPane.showMessageDialog(null, "¡El puesto esta en uso en un empleado, no se puede eliminar!");
                return false;
            }
            else
            {
