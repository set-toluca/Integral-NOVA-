 ...
 */
public class buscaEstatus extends javax.swing.JDialog {
    ...
    public buscaEstatus(java.awt.Frame parent, boolean modal, String ses, Usuario usuario) {
        super(parent, modal);
        sessionPrograma=ses;
        usr=usuario;
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Busqueda de estatus");
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Nombre del Estatus", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 11))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(usr.getConsultaEstatus()==true)
        {
            ...
            {
                Estatus op= new Estatus();
                op.setEstatusNombre(t_datos.getValueAt(t_datos.getSelectedRow(), 0).toString());
                op.setDescripcion(t_datos.getValueAt(t_datos.getSelectedRow(), 1).toString());
                doClose(op);
            }
            else
                JOptionPane.showMessageDialog(null, "¡No hay una estatus seleccionado!");        
        }
        else
    ...
    {
        String consulta="from Estatus obj where obj.descripcion like '%" + t_busca.getText() +"%'";
    ...
    private Estatus returnStatus = RET_CANCEL;
