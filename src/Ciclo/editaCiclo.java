 ...
 */
public class editaCiclo extends javax.swing.JPanel {
     ...
     */
    public editaCiclo(Usuario usuario, String ses) {
        initComponents();
        sessionPrograma=ses;
        usr=usuario;
        formatoTabla();
    ...
    private void initComponents() {
        ...
        t_ciclo = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Edita Ciclo", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 12))); // NOI18N
        ...
        t_ciclo.setNextFocusableComponent(t_descripcion);
        t_ciclo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                t_cicloActionPerformed(evt);
            }
        });
        t_ciclo.addKeyListener(new java.awt.event.KeyAdapter() {
        ...
        b_cancelar.setNextFocusableComponent(t_ciclo);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(t_ciclo, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(t_ciclo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(38, 38, 38)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void t_cicloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_t_cicloActionPerformed
        t_descripcion.requestFocus();
    }//GEN-LAST:event_t_cicloActionPerformed

    private void t_cicloKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_cicloKeyTyped
        char car = evt.getKeyChar();
        if(this.t_ciclo.getText().length()>=2)
            evt.consume();
        if((car<'0' || car>'9'))
            evt.consume();
    }//GEN-LAST:event_t_cicloKeyTyped
    ...
    public javax.swing.JTextField t_ciclo;
    ...
    {
        this.t_ciclo.setText("");
        this.t_descripcion.setText("");
    }

    public void cajas(boolean ciclo, boolean descripcion, boolean cancelar, boolean guardar)
    {
        this.t_ciclo.setEnabled(ciclo);
    ...
    private boolean modifica()
    {
        ...
        {   
            session.beginTransaction();
            Object resp=session.createQuery("from Ciclo obj where obj.idCiclo='"+t_ciclo.getText()+"' and obj.idCiclo!='"+ic+"'").uniqueResult();
            
            actor = (Ciclo)session.get(Ciclo.class, (Integer.parseInt(t_datos.getValueAt(t_datos.getSelectedRow(), 0).toString())));
            /*if(actor.getOrdens().isEmpty()==false) 
            {
                session.getTransaction().rollback();
            ...
            {*/
                if(resp==null)
                {
                    Query q = session.createQuery("update Ciclo obj set obj.descripcion='"+t_descripcion.getText()+"', obj.idCiclo='"+t_ciclo.getText()+"'where obj.idCiclo='"+ic+"'");
                    q.executeUpdate();
                    session.getTransaction().commit();
