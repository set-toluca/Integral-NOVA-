...
public class buscaCiclo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Nombre del Ciclo", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial", 1, 11))); // NOI18N
        ...
        if(usr.getEditaPeriodo()==true)
        {
            if(t_datos.getRowCount()>0)
            {
                if(t_datos.getSelectedRow()>=0)
                {
                    ...
                    JOptionPane.showMessageDialog(null, "¡No hay un Catálogo seleccionado!");
            }
        }
        else
