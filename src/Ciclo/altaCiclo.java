 ...
 */
public class altaCiclo extends javax.swing.JDialog {
     ...
     */
    public altaCiclo(java.awt.Frame parent, boolean modal, Usuario u, String ses) {
        super(parent, modal);
        user=u;
        sessionPrograma=ses;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Nota: Los ciclos son utilizados para agrupara las ordenes de taller se recomienda crear un ciclo por año.");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(t_ciclo, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))
    ...
    private void b_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_guardarActionPerformed
        ...
        if(t_ciclo.getText().compareTo("")!=0)
        {
            try
            {
                ...
                if(consultaCiclo(t_ciclo.getText())==false)
                {
                    Ciclo cic= new Ciclo();
                    cic.setIdCiclo(Integer.parseInt(t_ciclo.getText()));
                    cic.setDescripcion(t_descripcion.getText());

                    Integer ID=(Integer) session.save(cic);
        ...
        {
            JOptionPane.showMessageDialog(null, "¡Debe introducir el ciclo!");
            t_ciclo.requestFocus();
        }
    ...
    private boolean consultaCiclo(String ciclo)
    {
        List <Object[]> resultList=executeHQLQuery("from Ciclo obj where obj.idCiclo='"+ciclo+"'");
